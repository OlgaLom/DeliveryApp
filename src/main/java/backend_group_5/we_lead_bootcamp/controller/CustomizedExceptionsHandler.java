...
public class CustomizedExceptionsHandler  extends BaseComponent {
    ...
    private Object getApiError(final Exception ex, final HttpStatus status, final WebRequest request) {
