    ...
    public void run(String... args) throws Exception{
        ...
        List<Product> products = List.of(
                Product.builder().serial("SN1000-0002").name("HOT CHOCOLATE")
                        ...
                        .description("Classic Chocolate").store(storeService.getById(5L))
                        .sizes(Sizes.MEDIUM)
                ...
                Product.builder().serial("SN1100-0001").name("WAFFLE")
                        ...
                        .description("Waffle with Nutella").store(storeService.getById(10L))
                        .sizes(Sizes.NONE)
                        .flavours(Flavours.NONE)
                        .sauces(Sauces.NONE)
                ...
                Product.builder().serial("SN1100-0002").name("GREEK GIROS")
                        ...
                        .description("Greek Giros with fries").store(storeService.getById(8L))
                        .sizes(Sizes.LARGE)
                        .flavours(Flavours.NONE)
